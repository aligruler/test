 ...
 * @version 13810
 */
public class MultiStartSPupdateEachP {
	...
	MultiStartSPupdateEachP(Test myTest, Inputs myInputs, Random myRng) {
		aTest = myTest;
		inputs = myInputs;
		rng = myRng;
	}
	...
	public Outputs solve() {
		...
		for (int p = 0; p < aTest.getNumPeriods(); p++) {
			...
			//baseSolCurrentPeriod = new Solution(initSolPerPeriod[p]);
			//bestSolCurrentPeriod = new Solution(initSolPerPeriod[p]);
